...
public class HttpServerImpl extends AbstractVerticle
{
  ...
  private void sse(HttpServerRequest request)
  {
    ...
    ticks.handler(id ->
    {
      SensorDataService sensorDataService = SensorDataService.createProxy(vertx, "sensor.data-service");

//      sensorDataService.valueFor(consumer.handler(msg -> {msg.body().containsKey("id")}),);
    });
