...
public class ReadDB extends AbstractVerticle {
  private static final Logger logger = LoggerFactory.getLogger(ReadDB.class);

  public static void main(String[] args)
  {
    Vertx vertx = Vertx.vertx();

    vertx.deployVerticle(ReadDB.class.getName());
  }
