...
var sshMonitor =
  {
    sshMonitor : function ()
    {
      $("#dashboardDiv").html("<div class=\"container\"><div class=\"row\"><div class=\"box\"><span class=\"label\">Loss</span><span id=\"lossValue\"></span></div><div class=\"box\"><span class=\"label\">Uptime</span><span id=\"uptimeValue\"></span></div><div class=\"box\"><span class=\"label\">RTT</span><span id=\"rttValue\"></span></div><div class=\"box\"><span class=\"label\">CPU</span><span id=\"cpuValue\"></span></div><div class=\"box\"><span class=\"label\">Memory</span><span id=\"memoryValue\"></span></div><div class=\"box\"><span class=\"label\">Disk</span><span id=\"diskValue\"></span></div></div><div class=\"row1\"><div class=\"chart\" id=\"availabilityChart\"></div><div class=\"table-container\"><table id=\"dataTable\" class=\"scrollable-table\"><thead><tr><th style='width: 33%'>Interface Name</th><th style='width: 33%'>Receive BPS</th><th style='width: 33%'>Transmit BPS</th></tr></thead><tbody></tbody></table></div></div><div class=\"row\"><div class=\"chart\" id=\"lineChart\">24 Hours Rtt Chart</div><div class=\"chart\" id=\"earthChartCPU\">24 Hours CPU Used Chart</div></div><div class=\"row\"><div class=\"chart\" id=\"earthChartMemory\">24 Hours Memory Used Chart</div><div class=\"chart\" id=\"earthChartDisk\">24 Hours Disk Used Chart</div></div></div>")
    }
  };

var snmpMonitor =
  {
    snmpMonitor : function ()
    {
      $("#dashboardDiv").html("<div class=\"container\"><div class=\"row\"><div class=\"chart\" id=\"availabilityChart\"></div><div class=\"chart\" id=\"lineChart\">24 Hours Rtt Chart</div></div><div class=\"row\"><table class=\"attractive-table\"><thead><tr><th>Title</th><th>Data</th></tr></thead><tbody id=\"systemData\"></tbody></table></div><div class=\"row\"><table id=\"interfaceTable\" style='width: 100px; height: 100px'></table></div></div>")
    }
  }
