...
var viewMonitor =
  {
    ...
    {
      $("#dashboardDiv").html("<div id=\"viewMonitorDiv\"><div class=\"row\"><div class=\"col\"><div class=\"small-box\" id=\"lossBox\" style=\"background-color: red; height: 100px; display: flex; align-items: center; justify-content: center; color: white; font-size: 20px; font-weight: bold;\"><div id=\"lossLabel\">Loss</div><div id=\"lossValue\"></div></div></div><div class=\"col\"><div class=\"small-box\" id=\"rttBox\" style=\"background-color: blue; height: 100px; display: flex; align-items: center; justify-content: center; color: white; font-size: 20px; font-weight: bold;\"><div id=\"rttLabel\"></div><div id=\"rttValue\"></div></div></div></div><div class=\"row\"><div class=\"col\" style=\"height: 300px; width: 600px;\"><canvas id=\"availabilityChart\" ></canvas></div></div><div class=\"row\"><div class=\"col\" style=\"height: 300px; width: 600px;\"><canvas id=\"metricChart\"></canvas></div></div></div>")
    }
  };
